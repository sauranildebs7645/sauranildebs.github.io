...
layout: post
section-type: post
title: Grad-CAM: Making Off-the-shelf Deep Models Transparent threough
Visual Explanations
category: tech
tags: [ 'grad-cam' ]
---
...
According to a [recent paper presented at ICML workshop](https://arxiv.org/abs/1606.08813), a new regulation is coming out in Europe that states that “*whenever human subjects have their lives significantly impacted by an automatic decision making machine, the human subject has the right to know why the decision is made- i.e. right to explanation*”. This is supposed to turn into a law as early as 2018. So this isn't just an academic exercise anymore!

Let's now look at some scenarios where this sort of transparency and interpretability can help. Take the case where an AI system is significantly weaker than humans, and not reliably deployable in real world applications (eg. visual question answering), the goal of transparency and explanations would be to identify failure modes, which can help researchers to focus their efforts on the most fruitful research directions. Going one level up, take the case of an AI system that is on par with humans and is reliably deployable, (e.g., image classification and self-driving cars to some extent), the goal is to establish trust with end users using this application. Going to the highest level where the AI does significantly better than well trained humans (e.g. chess or Go playing bots), the goal of transparency and explanations can be machine teaching – i.e., a machine teaching a human on how to make accurate decisions. 

In order to build trust in intellegent systems and move towards their meaningful integration into our everyday lives, it is clear that we must build ‘transparent’ models that explain why they predict what they do.
...
![alt text](http://i.imgur.com/FXxnSt4.png"Gradients")
...
![alt text](http://i.imgur.com/LUDL1V5.jpg"Cat_Dog")
...
![alt text](http://i.imgur.com/LWlaTLS.png"Cat_Dog")
...
![alt text](http://i.giphy.com/26xBL7wCaRe6SqFDq.gif"CAM_fig")
...
![alt text](http://i.imgur.com/ObMP5b3.jpg"CAM_approach")
...
![alt text](http://i.imgur.com/BbTL40i.jpg"guidedgradcam_cat_dog")
...
![alt text](http://i.imgur.com/hGOJv2r.jpg"captioning")
...
![alt text](http://i.imgur.com/nzsDorc.png"captioning_more")
...
![alt text](http://i.imgur.com/FczOO7b.jpg"vqa")
...
![alt text](http://i.imgur.com/UNx369c.jpg"vqa_res")
...
![alt text](http://i.imgur.com/W5qyE4A.png"CAM_results")
